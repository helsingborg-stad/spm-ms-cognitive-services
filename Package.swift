...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "TTS", url: "https://github.com/helsingborg-stad/spm-tts.git", from: "0.1.1"),
        .package(name: "STT", url: "https://github.com/helsingborg-stad/spm-stt.git", from: "0.1.1"),
